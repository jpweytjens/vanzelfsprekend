"""Render the README figure: measured speeds against a backsolved model curve.
...
imply at any gradient, and measured speeds scatter around that curve.
"""
...
def main() -> None:
    ...
    ax.plot(100 * grid, backsolved_speed(grid), color="tol:orange", linewidth=1.8)
    ax.text(-6.0, 50, "measured", color=vfs.palettes.DATA_INK)
    ax.text(4.0, 28, "backsolved", color="tol:orange")
